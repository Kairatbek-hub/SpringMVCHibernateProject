...
public class JPAConfig implements WebMvcConfigurer {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/springproject");
        dataSource.setUsername("postgres");
        dataSource.setPassword("Shabotoev92@");
        return dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("peaksoft.model");
...
//    public CompanyDao getCompanyDao(EntityManagerFactory entityManager) {
//        return new CompanyDaoImpl(entityManager);
//    }

//    @Autowired
//    @Bean(name = "courseDao")
//    public CourseDao getCourseDao(EntityManagerFactory entityManager) {
